...
public class studentResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentResult.setBackground(new java.awt.Color(255, 153, 153));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select student.name , result.* from result LEFT JOIN student ON result.rollNo = student.rollNo");
